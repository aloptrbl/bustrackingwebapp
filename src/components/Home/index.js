    ...
    <div class="bg-blue-800 relative h-full min-h-screen w-1/6">
      <div class="xl:py-2">
        ...
        <div class="group relative sidebar-item with-children">
          <a href="/home" class="block bg-gray-900 xl:flex xl:items-center text-center xl:text-left shadow-light xl:shadow-none py-6 xl:py-2 xl:px-4 border-l-4 border-transparent hover:bg-gray-900">
